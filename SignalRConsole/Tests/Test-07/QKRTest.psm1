...
function Get-Description($qkr)
{
	...
	with Check-QKRTest 1.
	
	Next run Test-QKRas Fred in one console and log in as Bruce on
	QKR and add Mom. Run Test-QKRas Mom in another console. Pop to Home on QKR.
