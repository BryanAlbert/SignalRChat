...
function Get-Description($qkr)
{
	...
	connect as Fred on QKR and add Bruce (bruce@hotmail.com), run Start-TestFor
	...
	Start-TestFor Fred, connect again as Bruce and accept friend request. Verify
	status and close QKR and verify that Fred has exited. Run Check-Test `$true to
	validate the test.`n"
	}
}
