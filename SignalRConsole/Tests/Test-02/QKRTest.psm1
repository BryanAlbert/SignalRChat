...
function Get-Description($verbose)
{
	...
	Next Connect Internet as Fred on QKR and run Start-TestFor Bruce, accept friend
	request, verify friendship, that Bruce exits, then pop to Home and exit QKR.
