...
function Get-Description
{
	...
	and Fred list, go offline, Mom lists and goes offline.
	
	To test QKR, log in as Mom on QKR, run Test-QKRas Bruce in one console and
	Test-QKRas Fred in another. Test intermediate output with Check-QKRTest 1. Run 
	Test-QKRas Mom in one console, log in as Bruce on QKR, add Mom, then run
	Test-QKRas Fred in another console. Run Check-QKRTest 2 to validate the test.`n"
}
