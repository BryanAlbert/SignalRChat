...
function Get-Description($qkr)
{
	...
	Next, connecgt as Bruce on QKR, unfriend Fred, verify the Status message and pop
	back to Home. Run Start-TestFor Fred. Connect on QKR again, verify that Fred exits
	and pop to Home. Run Check-Test `$true to validate the test.`n"
	}
}
