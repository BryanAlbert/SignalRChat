...
function Get-Description($qkr)
{
	...
	{
	"`tTo test QKR, run Reset-Test `$true then log in as Bruce on QKR and add Fred,
	verify the status message and pop to Home. Check results with Check-Test `$true.`n"
	}
}
